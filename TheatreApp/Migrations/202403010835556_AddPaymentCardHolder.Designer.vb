...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddPaymentCardHolder
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddPaymentCardHolder))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202403010835556_AddPaymentCardHolder"
            End Get
        End Property
