...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ModelChanged
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ModelChanged))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202403050615507_ModelChanged"
            End Get
        End Property
