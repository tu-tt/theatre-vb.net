...
<body>
    <div class="container body-content py-4" style="padding-top: 64px !important">
        <form action="/Admin/Login" method="post" class="m-auto" style="width: fit-content">
            ...
            <a href="/Admin/Register" class="btn btn-outline-primary btn-link">Register Account</a>
        </form>
    </div>
